...
fetch(url)
    ...
    .then(data => {
        ...
        const html = destinations.map(d => {
            ...
            return `
                                    <article class="card">
                                            ${image ? `<a href="detalje.html?id=${id}"><img src="img/${image}" alt="${title || destination}"></a>` : ''}
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <a class="more-btn" href="detalje.html?id=${id}">MORE</a>
                                            </div>
                                    </article>
                            `;
        }).join('');

        if (mainWrapper) mainWrapper.innerHTML = html;
    })
